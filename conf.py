# -*- coding: utf-8 -*-
#
# py_sonicvisualiser documentation build configuration file, created by
...
# os.path.abspath('py_sonicvisualiser/SVEnv.py')
...
htmlhelp_basename = 'py_sonicvisualiserdoc'
